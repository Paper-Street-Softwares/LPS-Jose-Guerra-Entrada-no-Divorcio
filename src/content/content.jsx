  ...
  texts: {
    ...
    hero: {
      ...
      obsHero: {
        ...
        text: "Atendimento direto com Advogada",
    ...
    important: {
      ...
      cards: {
        ...
        card2: {
          ...
          paragraph:
            "Sim. A lei exige a participação de um advogado para formalizar o divórcio. O advogado garante que o acordo seja feito corretamente, cuidando da divisão de bens, guarda dos filhos, visitas e pensão alimentícia, evitando problemas futuros.",
        },
        card3: {
        ...
        card4: {
          title: "E se meu ex não quiser se divorciar ou não quiser acordo?",
          paragraph:
            "Mesmo sem acordo é possível iniciar o processo. Nesse caso, o divórcio pode ser solicitado judicialmente, e o juiz analisará as questões como divisão de bens, guarda dos filhos e pensão alimentícia para garantir uma solução justa.",
        },
      },
